...
export const ui = {
  ...
  en: {
    ...
    'nav.faq': 'FAQ',
    'hero.title': 'PortoGate',
    'hero.subtitle': 'Personal gateway for secure connection',
    'hero.description': 'Modern solution for personal internet access with adaptation to your needs',
    'hero.cta': 'Get Started',
    'features.title': 'Features',
    'features.secure.title': 'Secure Connection',
    'features.secure.description': 'Reliable protection of your data with modern protocols',
    'features.fast.title': 'High Speed',
    'features.fast.description': 'Optimized servers for maximum performance',
    'features.simple.title': 'Easy to Use',
    'features.simple.description': 'Intuitive interface and quick setup',
    'features.support.title': '24/7 Support',
    'features.support.description': 'Technical support anytime via Telegram',
    'how.title': 'How it works',
    'how.step1': 'Open Telegram bot',
    'how.step2': 'Choose suitable plan',
    'how.step3': 'Get connection settings',
    'how.step4': 'Enjoy secure internet',
    'how.docs': 'Detailed instructions',
    'pricing.title': 'Pricing',
    'pricing.local.title': 'PortoLocal',
    'pricing.local.description': 'Access to familiar services in Russia, even when abroad',
    'pricing.global.title': 'PortoGlobal',
    'pricing.global.description': 'Safe and free internet from anywhere in the world',
    'pricing.period.label': 'Period:',
    'pricing.period.1day': '1 day',
    'pricing.period.7days': '7 days',
    'pricing.period.30days': '30 days',
    'pricing.period.90days': '90 days',
    'pricing.period.180days': '180 days',
    'pricing.devices.label': 'Number of devices:',
    'pricing.devices.1': '1 device',
    'pricing.devices.3': '3 devices',
    'pricing.devices.5': '5 devices',
